...
final class Util
{
    ...
    {
        if (is_subclass_of($obj, 'WebMatrixIDC\\Boleto\\Contracts\\Pessoa')) {
            $property = $obj;
            return $obj;
        } elseif (is_array($obj)) {
            $obj = new Pessoa($obj);
    ...
    public static function array_get($a, $b, $c){
