<?php
namespace WebMatrixIDC\Boleto\Cnab\Retorno;

use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab240\Detalhe as Detalhe240Contract;
use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab240\Header as Header240Contract;
use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab240\Trailer as Trailer240Contract;
use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab400\Detalhe as Detalhe400Contract;
use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab400\Trailer as Trailer400Contract;
use WebMatrixIDC\Boleto\Contracts\Cnab\Retorno\Cnab400\Header as Header400Contract;
use WebMatrixIDC\Boleto\Support\Collection;
...
abstract class AbstractRetorno implements \Countable, \SeekableIterator
{
    ...
    public function __construct($file)
    {
        ...
        $r = new \ReflectionClass('\WebMatrixIDC\Boleto\Contracts\Boleto\Boleto');
