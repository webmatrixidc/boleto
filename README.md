...
```
composer require webmatrixidc/boletoa
```

Ou adicione manualmente ao seu composer.json:

```
"webmatrixidc/boletoa": "dev-master"
```
...
```php
$beneficiario = new \WebMatrixIDC\Boleto\Pessoa([
    'nome' => 'ACME',
    'endereco' => 'Rua um, 123',
    'cep' => '99999-999',
    'uf' => 'UF',
...
$pagador = new \WebMatrixIDC\Boleto\Pessoa([
    'nome' => 'Cliente',
    'endereco' => 'Rua um, 123',
    'bairro' => 'Bairro',
    'cep' => '99999-999',
...
$boleto = new \WebMatrixIDC\Boleto\Boleto\Banco\Bb($boletoArray);
```
...
```php
// Gerar em PDF
$pdf = new \WebMatrixIDC\Boleto\Boleto\Render\Pdf();
...
// Gerar em HTML
$html = new \WebMatrixIDC\Boleto\Boleto\Render\Html();
...
$remessa = new \WebMatrixIDC\Boleto\Cnab\Remessa\Cnab400\Banco\Bb($remessaArray);
...
```php
$retorno = \WebMatrixIDC\Boleto\Cnab\Retorno\Factory::make('full_path_arquivo_retorno');
$retorno->processar();
